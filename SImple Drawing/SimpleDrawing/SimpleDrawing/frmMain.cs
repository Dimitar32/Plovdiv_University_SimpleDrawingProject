...
namespace SimpleDrawing
{
    public partial class frmMain : Form
    {
        ...
        private void projectCreateByToolStripMenuItem_Click(object sender, EventArgs e)
        {
            System.Windows.Forms.MessageBox.Show("Димитър Иванов, 2101262002");
        }

        private void helpToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            System.Windows.Forms.MessageBox.Show("При проблеми с проекта свържете се с доц. д-р Светослав Енков");
        }
